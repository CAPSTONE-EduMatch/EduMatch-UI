...
/**
 * Check if an email can send OTP based on rate limiting rules
...
/**
 * Record an OTP attempt for an email address
 * @param email - User's email address
...
/**
 * Get current OTP attempt information for an email
 * @param email - User's email address
...
/**
 * Clear OTP attempts for an email (useful for testing or admin actions)
 * @param email - User's email address
 * @returns Promise<void>
 */
