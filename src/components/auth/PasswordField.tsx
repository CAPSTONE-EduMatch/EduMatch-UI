...
import PasswordCriteriaChecker, { PasswordCriteriaType } from './PasswordCriteriaChecker';
        ...
        {showCriteria ? (
          <div className="  mb-2">
            <div className="relative">
              ...
              >
                {showPassword ? (
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 transition-opacity duration-200 m-auto" viewBox="0 0 20 20" fill="currentColor">
            ...
            <PasswordCriteriaChecker criteria={passwordCriteria} hasInput={hasInput} />
          </div>
        ) : (
          <div className="relative">
            <Input
