      ...
      <div className="w-full max-w-7xl mx-auto relative">
        ...
        <div className="relative bg-primary rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-12 text-center text-white overflow-hidden">
          <div className="relative z-10">
            ...
            <Button
              size="lg"
              className="bg-white text-primary hover:bg-gray-100 px-4 sm:px-6 md:px-8 lg:px-12 py-2 sm:py-3 rounded-full text-xs sm:text-sm md:text-base lg:text-lg font-semibold"
            >
              Sign in
            </Button>
          </div>
