...
> = ({ profile }) => {
	...
	const handleDeleteAccountConfirm = async () => {
		if (deleteConfirmation !== 'DEACTIVATE') {
			alert('Please type "DEACTIVATE" to confirm account deactivation')
			return
		}
				...
				<div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
					...
					<div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
						<p className="text-blue-800 text-sm">
							<strong>Note:</strong> Your institution data will be preserved and
					...
					<div className="space-y-6">
						...
						<div className="text-center">
							<h3 className="text-lg font-semibold text-gray-900 mb-2">
								Are you sure you want to deactivate your institution account?
							</h3>
							<p className="text-gray-600 mb-4">
								This will disable your institution account and hide your
								profile, but your data will be preserved. You can contact
								support to reactivate later.
							</p>
							<div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-4">
								<p className="text-sm text-orange-800 font-medium mb-2">
									Account deactivation will:
								</p>
								<ul className="text-sm text-orange-700 list-disc list-inside space-y-1">
									<li>Disable login access to your institution account</li>
									<li>Hide your institution from applicants and search</li>
						...
						<div className="flex gap-4 pt-4">
							...
							<Button
								...
								className="flex-1 py-3 bg-orange-600 hover:bg-orange-700 text-white disabled:opacity-50 disabled:cursor-not-allowed"
								disabled={
									deletingAccount || deleteConfirmation !== 'DEACTIVATE'
								}
							>
								{deletingAccount ? (
